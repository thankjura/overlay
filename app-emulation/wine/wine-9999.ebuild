...
src_prepare() {
	...
	rm "../${PULSE_PATCHES}"/0002-winmm-Do-not-blindly-reset-device-when-already-stopp.patch
	rm "../${PULSE_PATCHES}"/0004-dsound-Fix-IDirectSoundCaptureBuffer-Start-Stop-with.patch
	rm "../${PULSE_PATCHES}"/0010-mmdevapi-Fix-broken-test-required-to-pass-all-tests-.patch
