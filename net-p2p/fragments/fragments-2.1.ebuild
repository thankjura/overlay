...
inherit meson xdg-utils gnome2-utils cargo ninja-utils

# Generated by cargo ebuild 0.5.4
CRATES="
	aead-0.3.2
	aes-0.6.0
	aes-0.7.5
...
SRC_URI="https://gitlab.gnome.org/World/Fragments/-/archive/${PV}/Fragments-${PV}.tar.gz
...
# https://gitlab.gnome.org/World/Fragments/-/issues/182
# adopted the version bump solution from gdk4-0.4.8 to gdk4-0.4.9
...
src_compile() {
	...
	ln -s "${WORKDIR}/cargo_home" "build/cargo-home" || die "Cannot symlink to local cargo-home"
	meson_src_compile
}
