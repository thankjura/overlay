...
# $Header: /var/cvsroot/gentoo-x86/media-libs/avidemux-plugins/avidemux-plugins-2.6.5-r1.ebuild,v 1.1 2013/09/01 20:33:56 tomwij Exp $
...
IUSE="aac aften a52 alsa amr debug dts fontconfig fribidi jack lame libsamplerate mmx opengl oss pulseaudio qt4 gtk vorbis truetype twolame xv xvid x264 vpx"
KEYWORDS="~amd64 ~x86"
...
DEPEND="
	~media-video/avidemux-${PV}:${SLOT}[opengl?,qt4?,gtk?]
...
use gtk && processes+=" buildPluginsGtk:avidemux_plugins"
